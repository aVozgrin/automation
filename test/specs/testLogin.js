...
// 		expect(browser.waitForExist('span=The New password field is required.')).to.be.ok;
// 	});
...
// 		changePasswordButton.submitForm();
// 		expect(browser.waitForExist('span=The new password and confirmation password do not match.')).to.be.ok;
// 	});
...
// 		confirmPasswordField.setValue(newpass6.slice(0, 5));
// 		changePasswordButton.submitForm();
// 		expect(browser.waitForExist('span=The New password must be at least 6 characters long.')).to.be.ok;
// 	});
...
// 			confirmPasswordField.setValue(newpass6);
// 			changePasswordButton.submitForm();
// 			expect(browser.waitForExist('span=Password updated successfully')).to.be.ok;
// 			logOff();
// 		});
...
// 			loginButton.submitForm();
// 			expect(browser.getTitle()).to.equal('Merchants');
// 		});
...
describe('Test Merchants', function() {
	...
	it('- test', function(){
		browser.waitForExist("[data-row-id='0']");
		(function (){
