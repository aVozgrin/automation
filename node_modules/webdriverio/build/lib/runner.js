    ...
    (0, _createClass3.default)(Runner, [{
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            ...
                            case 40:
                                ...
                                return _context3.abrupt('return', this.runWatchMode(m.cid, config, m.specs));
        ...
        value: function runWatchMode(cid, config, specs) {
            ...
            this.gaze.on('changed', function () {
                var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(filepath) {
                    var failures;
